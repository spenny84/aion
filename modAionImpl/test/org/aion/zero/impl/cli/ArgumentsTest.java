...
public class ArgumentsTest {
    ...
    public void testPreprocess_wCreate() {
        // first parameter
        String[] input = new String[]{"-a", "create", "-n", "mainnet", "-d", "abc",};
        String[] expected = new String[]{"-a create", "-n", "mainnet", "-d", "abc",};
    ...
    public void testPreprocess_wImport() {
        // first parameter
        String[] input = new String[]{"-a", "import", "0x123", "-n", "mainnet", "-d", "abc",};
        String[] expected = new String[]{"-a import", "0x123", "-n", "mainnet", "-d", "abc",};
    ...
    public void testPreprocess_wExport() {
        // first parameter
        String[] input = new String[]{"-a", "export", "0x123", "-n", "mainnet", "-d", "abc",};
        String[] expected = new String[]{"-a export", "0x123", "-n", "mainnet", "-d", "abc",};
    ...
    public void testPreprocess_wList() {
        // first parameter
        String[] input = new String[]{"-a", "list", "-n", "mainnet", "-d", "abc",};
        String[] expected = new String[]{"-a list", "-n", "mainnet", "-d", "abc",};
